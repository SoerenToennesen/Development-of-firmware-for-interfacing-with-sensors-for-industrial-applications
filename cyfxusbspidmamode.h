/*
 ## Cypress USB 3.0 Platform header file (cyfxusbspidmamode.h)
 ## ===========================
 ##
...
#ifndef _INCLUDED_CYFXUSBSPIDMAMODE_H_
#define _INCLUDED_CYFXUSBSPIDMAMODE_H_
...
#endif /* _INCLUDED_CYFXUSBSPIDMAMODE_H_ */
